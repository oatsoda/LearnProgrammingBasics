...
namespace _2_WhileLoop.Example
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // This is a "While Loop" which means everything inside will execute over and over again
            // until the condition is not met.
            while (input.ToLower() != "exit") // This is checking whether you typed "exit" in UPPER or lower case.
            { 
